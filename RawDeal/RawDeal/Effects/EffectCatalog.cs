...
{
    private static readonly Dictionary<string, List<Effect>> _effectCatalog = new();
        ...
        View view)
    {
        ...
        _effectCatalog["Haymaker"] = new List<Effect>
            { new AddBonusEffect(bonusManager, new EndOfTurnStrikeBonus(1)) };
        _effectCatalog["Back Body Drop"] = new List<Effect>
            { new ChooseBetweenDrawOrDiscard(2, view) };
        _effectCatalog["Shoulder Block"] = new List<Effect>
        {
        ...
        _effectCatalog["Cross Body Block"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Ensugiri"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Running Elbow Smash"] = new List<Effect>
            { new MoveTopCardOfArsenalToRingsidePile(view) };
        _effectCatalog["Drop Kick"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        ...
        _effectCatalog["Superkick"] = new List<Effect>
            { new AddBonusAfterXDamage(bonusManager, lastPlayInstance) };
        _effectCatalog["Spinning Heel Kick"] = new List<Effect>
            { new OpponentDiscardCardEffect(1, view) };
        _effectCatalog["Spear"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Clothesline"] = new List<Effect>
            { new AddBonusEffect(bonusManager, new NextManeuverBonusDamage(2, lastPlayInstance)) };
        ...
        _effectCatalog["Snap Mare"] = new List<Effect>
            { new AddBonusEffect(bonusManager, new NextManeuverStrikeDamage(2, lastPlayInstance)) };
        _effectCatalog["Double Leg Takedown"] =
            new List<Effect> { new MayDrawCardsEffect(1, view) };
        ...
        _effectCatalog["Headlock Takedown"] =
            new List<Effect> { new OpponentDrawCardEffect(1, view) };
        _effectCatalog["Belly to Belly Suplex"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Atomic Drop"] = new List<Effect>
            { new AddBonusEffect(bonusManager, new NextManeuverBonusDamage(2, lastPlayInstance)) };
        _effectCatalog["Vertical Suplex"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Belly to Back Suplex"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Pump Handle Slam"] = new List<Effect>
            { new OpponentDiscardCardEffect(2, view) };
        ...
        _effectCatalog["Bulldog"] = new List<Effect>
        {
            new DiscardOwnCardEffect(1, view), new ChooseCardThatOpponentWillDiscardEffect(1, view)
        };
        _effectCatalog["Fisherman's Suplex"] = new List<Effect>
            { new MoveTopCardOfArsenalToRingsidePile(view), new MayDrawCardsEffect(1, view) };
        _effectCatalog["DDT"] = new List<Effect>
        {
            new MoveTopCardOfArsenalToRingsidePile(view), new OpponentDiscardCardEffect(2, view)
        };
        ...
        _effectCatalog["Press Slam"] = new List<Effect>
        {
            new MoveTopCardOfArsenalToRingsidePile(view), new OpponentDiscardCardEffect(2, view)
        };
        _effectCatalog["Collar & Elbow Lockup"] =
            new List<Effect> { new DiscardCardToDrawOne(view) };
        ...
        _effectCatalog["Standing Side Headlock"] = new List<Effect>
            { new OpponentDrawCardEffect(1, view) };
        // TODO:When successfully played, look through your Arsenal for the card titled Maintain Hold and place that card in your hand, then shuffle your Arsenal.
        _effectCatalog["Cobra Clutch"] = new List<Effect> { new NoEffect() };
        _effectCatalog["Chicken Wing"] = new List<Effect>
            { new MoveFromRingsidePileToArsenal(2, view) };
        // TODO:When successfully played, look through your Arsenal for the card titled Maintain Hold and place that card in your hand, then shuffle your Arsenal.
        ...
        ;
        _effectCatalog["Guillotine Stretch"] = new List<Effect>
            { new OpponentDiscardCardEffect(1, view), new MayDrawCardsEffect(1, view) };
        ;
        ...
        _effectCatalog["Torture Rack"] = new List<Effect>
            { new OpponentDiscardCardEffect(1, view) };
        _effectCatalog["Figure Four Leg Lock"] = new List<Effect>
            { new OpponentDiscardCardEffect(1, view) };
        ...
        _effectCatalog["Rolling Takedown"] = new List<Effect>
            { new ReturnHashtagDamageEffect(lastPlayInstance, bonusManager, view) };
        _effectCatalog["Knee to the Gut"] = new List<Effect>
            { new ReturnHashtagDamageEffect(lastPlayInstance, bonusManager, view) };
        _effectCatalog["Elbow to the Face"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        _effectCatalog["Clean Break"] = new List<Effect>
            { new OpponentDiscardCardEffect(4, view), new DrawCardEffect(1, view) };
        _effectCatalog["Manager Interferes"] = new List<Effect>
        {
            new DrawCardWhenReversedFromHandEffect(1, view),
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        ...
        _effectCatalog["Jockeying for Position"] = new List<Effect>
            { new JockeyingEffect(bonusManager, view) };
        ...
        _effectCatalog["Offer Handshake"] = new List<Effect>
            { new MayDrawCardsEffect(3, view), new DiscardOwnCardEffect(1, view) };
        _effectCatalog["Roll Out of the Ring"] = new List<Effect>
            { new DiscardCardsAndReturnToHand(view) };
        ...
        _effectCatalog["Recovery"] = new List<Effect>
            { new MoveFromRingsidePileToArsenal(2, view), new DrawCardEffect(1, view) };

        _effectCatalog["Spit At Opponent"] = new List<Effect>
            { new DiscardOwnCardEffect(1, view), new OpponentDiscardCardEffect(4, view) };
        ...
        _effectCatalog["Puppies! Puppies!"] = new List<Effect>
            { new MoveFromRingsidePileToArsenal(5, view), new DrawCardEffect(2, view) };
        ...
        _effectCatalog["Lou Thesz Press"] = new List<Effect>
        {
            new MayDrawCardsEffect(1, view),
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        ...
        _effectCatalog["Undertaker's Tombstone Piledriver"] =
            new List<Effect> { new DiscardCardToDrawOne(view) };
        ...
        _effectCatalog["Double Arm DDT"] = new List<Effect>
        {
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
        ...
        _effectCatalog["Leaping Knee to the Face"] = new List<Effect>
            { new OpponentDiscardCardEffect(1, view) };

        _effectCatalog["Facebuster"] = new List<Effect>
        {
            new MayDrawCardsEffect(2, view),
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };

        _effectCatalog["I Am the Game"] = new List<Effect>
        {
            new AddBonusEffect(bonusManager, new EndOfTurnManeuverBonus(3)),
            new ChooseBetweenDrawOrDiscard(2, view)
        };
        ...
        _effectCatalog["Chyna Interferes"] = new List<Effect>
        {
            new DrawCardWhenReversedFromHandEffect(2, view),
            new ReturnPredeterminedDamageWhenReversedFromHandEffect(lastPlayInstance, bonusManager,
                view)
        };
    ...
    {
        if (_effectCatalog.ContainsKey(cardTitle)) return _effectCatalog[cardTitle];
